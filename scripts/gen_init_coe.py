...
def wait_stamp(time, design_freq):
    ...
    if(time_int > 2**16):
        logging.error("Time value to high,"
...
SOURCE is a header file generated by SiLabs software
    ...
    parser.add_option("-f", "--design-freq", action="store", type=int, dest="design_freq",
                      default=100e6, help="I2C clock speed module clocking [default: %default]")
    ...
    try:
        ...
        f = create_rom_content(args[0], 2**10, options.design_freq)
