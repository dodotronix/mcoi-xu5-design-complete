...
add_files [glob $modules_path/BI_HDL_Cores/cores_for_synthesis/ip_open_cores/crc/*.v]
add_files [glob $modules_path/BI_HDL_Cores/cores_for_synthesis/8b10b/*.v]
add_files [glob $modules_path/BI_HDL_Cores/cores_for_synthesis/GlitchFilter.v]
